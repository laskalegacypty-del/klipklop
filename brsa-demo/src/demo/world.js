...
export const RULE_BOOK = [
  ...
  { id: 'E', title: 'Timing & divisions', body: 'Section E.3: divisions 1D–5D are cut every 0.5 seconds off the fastest completed time in that class field. Place is inside the division. A two-run jackpot keeps the better run.' },
